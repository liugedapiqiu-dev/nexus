...
import { getTemplate, BUILTIN_TEMPLATES, } from '../mcp/templates-store.js';
export default {
...
async function decomposeGoal(goal, model) {
...
function makeErrorResult(goal, error, totalTasks, startTime) {
    return {
        workflow_id: 'error',
        success: false,
...
//# sourceMappingURL=orchestrate-goal.js.map