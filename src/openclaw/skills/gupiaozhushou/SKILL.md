---
name: gupiaozhushou
description: 财经分析工具包 - 股票分析、市场趋势预测、投资建议
version: 1.0.0
icon: 📈
...
metadata:
  openclaw:
    ...
    requires:
      bins: ["python", "curl"]
      python_packages: ["yfinance", "pandas", "numpy", "matplotlib"]
    install:
      - id: python-deps
        kind: pip
...
# 财经分析工具包 (Gupiaozhushou)

专业的财经分析工具包，为 AI Agent 提供全面的财经分析能力。包含股票数据分析、市场趋势预测、投资组合优化等功能。
...
gupiaozhushou/
├── SKILL.md              # 本文件
├── skill.json            # OpenClaw 技能配置
├── gupiaozhushou-财经分析工具包/
│   ├── SKILL.md          # 详细文档
│   ├── README.md         # 用户文档
│   ├── finance_toolkit.py # 核心 Python 模块
│   ├── examples/         # 使用示例
...
- v1.0.1 (2026-03-10): 添加顶层 SKILL.md，完善技能配置
